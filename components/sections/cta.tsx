...
export function CTA() {
  return (
    <section className="py-6 lg:py-10 bg-gradient-to-br from-secondary via-secondary/95 to-secondary relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-base md:text-lg text-secondary-foreground/80 leading-relaxed mb-5 max-w-2xl mx-auto">
