        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-slate max-w-none space-y-8 text-foreground">
            ...
            <div>
              ...
              <p className="text-base text-muted-foreground leading-relaxed mb-3">We collect and process the following categories of information in connection with our services:</p>

              <h3 className="text-lg font-semibold text-primary mb-2">2.1 Protected Health Information (PHI)</h3>
              <p className="text-base text-muted-foreground leading-relaxed mb-2">In performing revenue cycle management services, we may access, receive, transmit or process PHI including but not limited to:</p>
              ...
              <h3 className="text-lg font-semibold text-primary mt-5 mb-2">2.2 Methods of Data Access and Transfer</h3>
              <p className="text-base text-muted-foreground leading-relaxed mb-2">We access and receive client data through all channels necessary to perform our services, including:</p>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-base">
            ...
            {/* 3 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">3. How We Use Information</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-2">We use PHI and client data exclusively to perform contracted revenue cycle management services, including:</p>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-base">
            ...
            {/* 4 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">4. HIPAA Compliance and Business Associate Agreement</h2>
            ...
            {/* 5 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">5. Cross-Border Data Processing</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-3">
            ...
            {/* 6 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">6. How We Protect Information</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-3">We implement administrative, physical and technical safeguards to protect PHI and all client data, including:</p>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-base">
            ...
            {/* 7 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">7. Disclosure of Information</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-3">We disclose PHI only as permitted or required under HIPAA and as specified in the executed BAA. Permitted disclosures include:</p>
              <ul className="list-disc pl-6 space-y-1 text-muted-foreground text-base">
            ...
            {/* 9 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">9. Your Rights</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-3">
            ...
            {/* 10 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">10. Breach Notification</h2>
              <p className="text-base text-muted-foreground leading-relaxed">
            ...
            {/* 11 */}
            <div>
              <h2 className="text-2xl font-bold text-primary mb-3">11. Changes to This Policy</h2>
              <p className="text-base text-muted-foreground leading-relaxed">
            ...
            <div>
              ...
              <div className="bg-muted/50 rounded-xl p-5 border border-border space-y-2 text-sm text-muted-foreground">
